...
#ifndef protoDUNE_validate_calib_h
#define protoDUNE_validate_calib_h
...
class protoDUNE_validate_calib {
public :
...
#ifdef protoDUNE_validate_calib_cxx
protoDUNE_validate_calib::protoDUNE_validate_calib(TTree *tree) : fChain(0) 
{
...
protoDUNE_validate_calib::~protoDUNE_validate_calib()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t protoDUNE_validate_calib::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t protoDUNE_validate_calib::LoadTree(Long64_t entry)
{
...
void protoDUNE_validate_calib::Init(TTree *tree)
{
...
Bool_t protoDUNE_validate_calib::Notify()
{
...
void protoDUNE_validate_calib::Show(Long64_t entry)
{
...
Int_t protoDUNE_validate_calib::Cut(Long64_t entry)
{
...
#endif // #ifdef protoDUNE_validate_calib_cxx

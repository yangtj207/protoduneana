...
#ifndef protoDUNE_X_calib_h
#define protoDUNE_X_calib_h
...
#ifdef protoDUNE_X_calib_cxx
protoDUNE_X_calib::protoDUNE_X_calib(TTree *tree) : fChain(0) 
{
...
protoDUNE_X_calib::~protoDUNE_X_calib()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t protoDUNE_X_calib::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t protoDUNE_X_calib::LoadTree(Long64_t entry)
{
...
void protoDUNE_X_calib::Init(TTree *tree)
{
...
Bool_t protoDUNE_X_calib::Notify()
{
...
void protoDUNE_X_calib::Show(Long64_t entry)
{
...
Int_t protoDUNE_X_calib::Cut(Long64_t entry)
{
...
#endif // #ifdef protoDUNE_X_calib_cxx

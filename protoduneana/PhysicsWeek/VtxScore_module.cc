...
class pdsp::VtxScore : public art::EDAnalyzer {
public:
  explicit VtxScore(fhicl::ParameterSet const& p);
  ...
  VtxScore& operator=(VtxScore&&) = delete;
...
DEFINE_ART_MODULE(pdsp::VtxScore)
